...
supplierVatRegistrationNumber.error.invalid = Enter a valid supplier’s VAT registration number
supplierVatRegistrationNumber.error.length = The supplier’s VAT registration must be 12 characters or less
