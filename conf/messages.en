...
refundPeriod.start.error.beforeVatRegDate.remainingQuarter = Refund period start date must be at least three months before VAT registration date if you did not register for VAT during the first quarter of the year
