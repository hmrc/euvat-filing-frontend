...
import models.{InvoiceType, NormalMode, UserAnswers}
  ...
  "InvoiceType Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(form, NormalMode, routes.AboutThePurchaseController.onPageLoad())(request,
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      running(application) {
        ...
        status(result) mustEqual OK
        contentAsString(result) mustEqual view(form.fill(InvoiceType.values.head), NormalMode, routes.AboutThePurchaseController.onPageLoad())(
          request,
          messages(application)
        ).toString
      }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(boundForm, NormalMode, routes.AboutThePurchaseController.onPageLoad())(request,
                                                                                                                      messages(application)
                                                                                                                     ).toString
      }
    }
