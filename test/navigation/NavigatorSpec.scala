...
class NavigatorSpec extends SpecBase {
  ...
  "Navigator" - {
    ...
    "in Normal mode" - {
      ...
      "must go from TotalPurchaseAmountBeforeVatPage to PurchaseTypeController" in {
    ...
    "in Check mode" - {
      ...
      "must go from TotalPurchaseAmountBeforeVatPage to CheckYourClaimDetailsController in CheckMode" in {
