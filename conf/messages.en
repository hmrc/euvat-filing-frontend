...
sadReferenceNumber.hint = Enter the SAD reference number from your import document
sadReferenceNumber.error.required = Enter your Single Administrative Document (SAD) reference number
sadReferenceNumber.error.invalid = Enter a SAD reference number in the correct format
