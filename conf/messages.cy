...
refundPeriod.title = Cyfnod yr ad-daliad
refundPeriod.heading = Cyfnod yr ad-daliad
refundPeriod.rules.heading = Mae’n rhaid i gyfnod eich ad-daliad:
refundPeriod.rule.1 = fod yn y gorffennol
refundPeriod.rule.2 = fod o fewn yr un flwyddyn galendr
refundPeriod.rule.3 = fod o leiaf 3 mis o hyd, oni bai ei fod yn dod i ben ym mis Rhagfyr (er enghraifft, mae 10 2025 i 12 2025 yn cyfrif fel 3 mis)
refundPeriod.rule.4 = beidio â gorgyffwrdd â chyfnod rydych eisoes wedi gwneud hawliad amdano
...
refundPeriod.start.heading = Pryd mae dyddiad cychwyn cyfnod yr ad-daliad?
refundPeriod.start.hint = Er enghraifft, 10 2025
refundPeriod.start.error.required = Nodwch y dyddiad dechrau
refundPeriod.start.error.required.month = Nodwch y mis dechrau
refundPeriod.start.error.required.year = Nodwch y flwyddyn dechrau
refundPeriod.start.error.invalidDateFormat = Nodwch ddyddiad dechrau dilys
refundPeriod.start.error.invalidDateFormat.month = Nodwch fis dechrau dilys
refundPeriod.start.error.invalidDateFormat.year = Nodwch flwyddyn dechrau dilys
refundPeriod.start.error.after30Sept = Ni all dyddiad decrhau cyfnod yr ad-daliad fod cyn 1 Ionawr {0}
refundPeriod.start.error.30SeptOrEarlier = Ni all dyddiad decrhau cyfnod yr ad-daliad fod cyn 1 Ionawr {0}
refundPeriod.start.error.beforeVatRegDate.firstQuarter = Mae’n rhaid i ddyddiad dechrau cyfnod yr ad-daliad fod ar ôl y dyddiad cofrestru ar gyfer TAW os gwnaethoch gofrestru ar gyfer TAW yn ystod y chwarter cyntaf
refundPeriod.start.error.beforeVatRegDate.remainingQuarter = Mae’n rhaid ddyddiad dechrau cyfnod yr ad-daliad fod o fewn tri mis cyn neu unrhyw bryd ar ôl y dyddiad cofrestru ar gyfer TAW os na wnaethoch gofrestru ar gyfer TAW yn ystod y chwarter cyntaf
refundPeriod.end.heading = Pryd yw dyddiad diwedd cyfnod yr ad-daliad?
refundPeriod.end.hint = Er enghraifft, 12 2025
refundPeriod.end.error.required = Nodwch y dyddiad dod i ben
refundPeriod.end.error.required.month = Nodwch y mis dod i ben
refundPeriod.end.error.required.year = Nodwch y flwyddyn dod i ben
refundPeriod.end.error.invalidDateFormat = Nodwch ddyddiad dod i ben dilys
refundPeriod.end.error.invalidDateFormat.month = Nodwch fis dod i ben dilys
refundPeriod.end.error.invalidDateFormat.year = Nodwch flwyddyn dod i ben dilys
refundPeriod.end.error.inPast = Mae’n rhaid i ddyddiad diwedd cyfnod yr ad-daliad fod yn y gorffennol
...
contactDetails.error.email.required = Nodwch gyfeiriad e-bost
contactDetails.error.email.maxLength = Mae’n rhaid i’r cyfeiriad e-bost fod yn 100 o gymeriadau neu lai
contactDetails.error.email.invalidFormat = Nodwch gyfeiriad e-bost yn y fformat cywir, fel enw@enghraifft.com
contactDetails.error.telephone.maxLength = Mae’n rhaid i’r cyfeiriad e-bost fod yn 100 o gymeriadau neu lai
contactDetails.error.telephone.format = Nodwch rif ffôn yn y fformat cywir
