...
refundingCountry.title = O ba aelod-wladwriaeth yr UE ydych chi’n hawlio TAW yn ôl?
refundingCountry.heading = O ba aelod-wladwriaeth yr UE ydych chi’n hawlio TAW yn ôl?
refundingCountry.hint = Dechreuwch deipio i ddod o hyd i’r aelod-wladwriaeth
refundingCountry.error.summary = Dewiswch aelod-wladwriaeth yr UE
refundingCountry.error.required = Dewiswch aelod-wladwriaeth yr UE
refundingCountry.error.invalid = Dewiswch aelod-wladwriaeth yr UE dilys
refundingCountry.error.invalid.summary = Dewiswch aelod-wladwriaeth yr UE dilys
...
refundingLanguage.title = Pa iaith ydych am ei defnyddio ar gyfer yr hawliad hwn?
refundingLanguage.heading = Pa iaith ydych am ei defnyddio ar gyfer yr hawliad hwn?
refundingLanguage.error.required = Dewiswch iaith ar gyfer yr hawliad hwn
refundingLanguage.checkYourAnswersLabel = Iaith ar gyfer yr hawliad
refundingLanguage.change.hidden = Newidiwch yr iaith
refundingLanguage.hint = Mae’n rhaid uwchlwytho pob dogfen ategol yn yr iaith a ddewiswch
refundingLanguage.english = English
refundingLanguage.german = Almaenaidd
refundingLanguage.french = Ffrengig
refundingLanguage.dutch = Iseldiraidd
refundingLanguage.bulgarian = Bwlgaraidd
refundingLanguage.spanish = Sbaenaidd
refundingLanguage.turkish = Twrcaidd
refundingLanguage.czech = Tsiecaidd
refundingLanguage.danish = Danaidd
refundingLanguage.estonian = Estonaidd
refundingLanguage.finnish = Ffinnaidd
refundingLanguage.swedish = Swedaidd
refundingLanguage.italian = Eidalaidd
refundingLanguage.latvian = Latfiaidd
refundingLanguage.lithuanian = Lithwaniaidd
refundingLanguage.maltese = Maltaidd
refundingLanguage.polish = Pwylaidd
refundingLanguage.portuguese = Portiwgeaidd
refundingLanguage.romanian = Rwmanaidd
refundingLanguage.slovak = Slofacaidd
refundingLanguage.slovenian = Slofenaidd
refundingLanguage.irish = Gwyddelig
refundingLanguage.hungarian = Hwngaraidd
refundingLanguage.greek = Groegaidd
