...
refundPeriod.error.periodStartDateBeforeRegDate = Refund period start date must be either 3 months before or on or after registration date
refundPeriod.error.periodEndDateBeforeDeRegDate = Refund period end date must be before de-registration date
