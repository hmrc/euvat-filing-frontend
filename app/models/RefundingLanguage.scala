...
object RefundingLanguage extends Enumerable.Implicits {
  ...
  val values: Seq[RefundingLanguage] = Seq(
    English, German, French, Dutch, Bulgarian, Spanish, Turkish, Czech,
    Danish, Estonian, Finnish, Swedish, Italian, Latvian, Lithuanian,
    Maltese, Polish, Portuguese, Romanian, Hungarian, Greek, Slovak, Slovenian, Irish
  )
