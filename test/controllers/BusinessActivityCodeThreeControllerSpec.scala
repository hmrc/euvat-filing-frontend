  ...
  "BusinessActivityCodeThree Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(form, activities, Some(routes.BusinessActivityCodeTwoController.onPageLoad(models.NormalMode).url), models.NormalMode)(request, messages(application)).toString
      }
    }
