...
refundPeriod.start.error.inPast = Refund period start date must be in the past
...
refundPeriod.error.startAndEndInPast = Refund period start date and end date must be in the past
