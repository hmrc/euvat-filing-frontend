...
class DeleteClaimControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val deleteClaimRoute = routes.DeleteClaimController.onPageLoad(NormalMode).url
  ...
  "DeleteClaim Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DeleteClaimPage, true).success.value
