...
refundPeriod.start.error.after30Sept = Refund period start date must be on or after 1 January {0}
refundPeriod.start.error.30SeptOrEarlier = Refund period start date must be on or after 1 January {0}
