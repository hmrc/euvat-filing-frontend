...
import models.{NormalMode, InvoiceType, UserAnswers}
  ...
  "InvoiceType Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      running(application) {
        ...
        status(result) mustEqual OK
        contentAsString(result) mustEqual view(form.fill(InvoiceType.values.head), NormalMode)(request, messages(application)).toString
      }
    }
